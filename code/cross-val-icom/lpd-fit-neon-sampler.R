# Predict NEON data using the NEON model where 
# predictions are generated from some other combination of data 
elpd.neon.fit.pred <- function(samples.fit, samples.pred, elev.pred, for.pred, my.iter, 
		               n.iter, I, n.years) {
  ...
  beta.0.fit <- array(beta.0.fit, dim = c(n.iter, I.neon, n.years))
