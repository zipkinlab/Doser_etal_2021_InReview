...
source("code/cross-val-icom/nimble-code/icom-HBEF-BBS.R")
...
icom.consts <- list(n.years = n.years, I = I,
		   ...
		   J.hbef = J.hbef.fit, J.bbs = J.bbs.fit)
...
file.name <- paste('results/icom-HBEF-BBS-results-', n.iter, '-iterations-', curr.set, '-holdout-', 
		   date, '.R', sep = '')
