...
#                   HBEF and NEON data for cross validation. See 
#                   code/wmnf/main-HBEF-NEON.R for more detailed commenting
...
library(nimble)
library(coda)
# This index is used to run these multiple hold out datsets across multiple cores. By
...
source("code/cross-val-icom/nimble-code/icom-HBEF-NEON.R")
...
file.name <- paste('results/icom-HBEF-NEON-results-', n.iter, '-iterations-', curr.set, '-holdout-', 
		   date, '.R', sep = '')
